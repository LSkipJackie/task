...
class UserCenterController extends BasicUserCenterController
{
    ...
    public function index()
    {
        ...
        $userAuth = AuthRecordModel::where('uid', $this->user['id'])->where('status', 2)->where('auth_code','!=','realname')->orWhere(['status' => 1, 'auth_code' => 'realname','uid' => $this->user['id']])->get()->toArray();
