    ...
    public function checkDatabase(CheckDatabaseRequest $request)
    {
        ...
        if ($link){
            ...
            $configData = [
                ...
                'MAIL_PASSWORD' => 'null',
                'MAIL_ENCRYPTION' => 'tls',
                'ALIPAY_RETURN_URL' => $arrRequest['site_url'] . '/finance/pay/alipay/return',
                'ALIPAY_NOTIFY_URL' => $arrRequest['site_url'] . '/finance/pay/alipay/notify',
                'WECHAT_NOTIFY_URL' => $arrRequest['site_url'] . '/finance/pay/wechat/notify'
            ];
            $data = '';
