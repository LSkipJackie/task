                        ...
                        <li>
                            ...
                            <div id="demo" class="collapse in">
                                ...
                                <div class="clearfix">
                                    ...
                                    <input type="hidden" name="description" id="discription-edit"  value="{!! old('description') !!}{{ $task->desc }}" datatype="*1-2048" nullmsg="需求描述不能为空" errormsg="字数超过限制">
                                    </div>
                                    ...
                                    <div class="collapse in" id="ck">
                                        <div class="mission-ck ">
                                            ...
                                            <span class="input-group-addon date-icon">
                                                ...
                                                <input type="text" class="input-sm form-control datepicker" id="datepiker-begin" onchange="beginAt($(this))"  value="{!! old('start') !!}{{ date('Y年m月d日',strtotime($task['begin_at'])) }}"  placeholder="开始时间" >
                                            <span class="input-group-addon  date-icon ">
                                                <i class="fa fa-exchange"></i>
                                            </span>
                                                <input type="text" class="input-sm form-control datepicker" id="datepiker-deadline" onchange="deadline($(this))"  value="{!! old('delivery_deadline') !!}{{ date('Y年m月d日',strtotime($task['delivery_deadline'])) }}"  placeholder="结束时间">
                                            </div>
                                            ...
                                            <input name="begin_at" type="hidden" value="{!! old('start') !!}{{ date('Y年m月d日',strtotime($task['begin_at'])) }}" id="begin_at" datatype="*" nullmsg="请填写开始时间！" />
                                            <input name="delivery_deadline" value="{!! old('delivery_deadline') !!}{{ date('Y年m月d日',strtotime($task['delivery_deadline'])) }}"  type="hidden" id="delivery_deadline" ajaxurl="/task/checkdeadline"  datatype="*" nullmsg="请填写截稿时间！"  />
