<div class="g-main g-releasetask g-usershop">
    ...
    <form method="post" action="/user/postEditShopSuccess" enctype="multipart/form-data" id="shopSuccess">
        ...
        <div class="g-userimgup profile-users g-usershopform">
            ...
            <div class="clearfix g-userimgupbor task-casehid"><p class="pull-left h5 cor-gray51">作品名称</p>
                <p class="g-userimgupinp g-userimgupbor-validform">
                    <input class="inputxt Validform_error input-large" type="text" datatype="*1-30"
                           nullmsg="请填写作品名称" errormsg="字数超过限制" name="title" value="{!! $success_info->title !!}">&nbsp;&nbsp;&nbsp;
                </p>
            </div>
            <div class="clearfix g-userimgupbor task-casehid"><p class="pull-left h5 cor-gray51">作品描述</p>
                <div class="g-userimgupinp g-userimgupbor-validform clearfix">
                    <div class="clearfix  Validform-wysiwyg-editor">
                        <script id="editor" name="description" type="text/plain">{!! htmlspecialchars_decode($success_info->desc) !!}</script>
                        {{--<div class="wysiwyg-editor" id="editor1">{!! htmlspecialchars_decode($success_info->desc) !!}</div>
                        <input type="hidden" name="description" id="discription-edit" datatype="*" nullmsg="作品描述不能为空"--}}
                    </div>
                </div>
            </div>
            <div class="clearfix g-userimgupbor" data-placement="right" href="#">
                ...
                <div class="memberdiv pull-left">
                    <div class="position-relative">
                        <input name="success_pic" type="file" id="id-input-file-6" datatype="*" nullmsg="作品封面不能为空"/>
                    </div>
                </div>
            ...
            <div class="clearfix g-userimgupbor task-casehid"><p class="pull-left h5 cor-gray51">作品链接</p>
                <p class="g-userimgupinp g-userimgupbor-validform">
