    ...
    <div class="row">
        <div class="col-lg-3 col-left">
                ...
                <div class="col-sm-6 col-lg-12">
                    ...
                    <div class=" g-usericon">
                        @if($auth_user['bank'] == true)
                            <a class="u-bankiconact" ></a>
                        @else
                            <a class="u-bankicon "></a>
                        @endif

                        @if($auth_user['realname'] == true)
                            <a class="u-infoiconact" ></a>
                        @else
                        ...
                        @else
                            {{--<a class="u-email" href="{!! url('user/emailAuth') !!}"></a>--}}
            ...
            <div class="row g-userinfo visible-lg-block col-lg-12">
                <div class="col-xs-6 text-center g-userborr"><a><b>{{ $focus_num }}</b></a><p class="text-size14 g-usermarbot2">关注</p></div>
                <div class="col-xs-6 text-center"><a ><b>{{ $fans_num }}</b></a><p class="text-size14 g-usermarbot2">粉丝</p></div>
