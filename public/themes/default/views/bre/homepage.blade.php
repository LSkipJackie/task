                        ...
                        <li class="col-lg-3  col-md-4 col-sm-4 col-xs-6 u-listitem1 col-left col-right">
                            <div class="u-index">
                                ...
                                <div class="g-scueeitem1 clearfix  p-space">
                                    <h4 class="text-size14 mg-margin p-space"><a href="{{$v4['url']}}" target="_blank" class="cor-gray51">{{$v4['title']}}</a></h4>
                                    <div class="space-12"></div>
                                    <div class="clearfix p-space">
                                        <a href="{{$v4['url']}}" target="_blank" class="pull-left"><img src="@if(!empty($v4['avatar'])){{url($v4['avatar'])}} @else {!! Theme::asset()->url('images/default_avatar.png') !!}@endif" height="37" width="37" alt="" class="img-circle"></a>
...
<div class="clearfix g-info">
    ...
    <div class="clearfix">
        ...
        <div class="col-lg-4 hidden-xs hidden-md hidden-sm col-left col-right">
            ...
            <div class="f-pr">
                <a href="{{$article[0]['url']}}" target="_blank"><img src="{{url($article[0]['recommend_pic'])}}" alt="" class="img-responsive j-img"></a>
                <div class="f-prwarp">
                    <h5><a href="{{$article[0]['url']}}" target="_blank" class="cor-white">{{$article[0]['recommend_name']}}</a></h5>
                </div>
            </div>
            @endif
        </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 g-infoitem f-pd clearfix col-left col-right" >
                    <div class="clearfix b-border">
                        <div class="pull-left u-infowrap">
                            <a href="{{$v5['url']}}" target="_blank" class="cor-gray51"><img src="{{url($v5['recommend_pic'])}}" alt="" class="j-img img-responsive pull-left"></a>
                        </div>
                        <div class="u-infoItm clearfix">
                            <h4 class="text-size16 p-space"><a href="{{$v5['url']}}" class="cor-gray51">{{$v5['recommend_name']}}</a></h4>
                            <div class="space-2"></div>
                            <p class="cor-gray97">@if(mb_strlen($v5['summary']) > 45){!! mb_substr($v5['summary'],0,45,'utf-8') !!}...@else {!! $v5['summary'] !!} @endif</p>
                    ...
                    @if($friendUrl)
                        @foreach($friendUrl as $k6 => $v6)
                            <li class=" text-center u-item">
                                <div class="">
                                    <a target="_blank" href="{{url($v6['content'])}}"><img src="{{url($v6['pic'])}}" alt="kppw"></a>
                                </div>
                            </li>
                        @endforeach
                    @endif
