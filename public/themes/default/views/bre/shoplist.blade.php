    ...
    <div class="col-lg-9 col-left">
            <div class="g-taskclassify g-serivceitem hidden-xs">
                <div class="col-md-12 col-xs-12 serivce-type">
                    ...
                    <div>
                        <a class="{!! !isset($merge['type'])?'bg-blue':'' !!}" href="{!! URl('bre/shop') !!}">全部</a>
                        {{--<a class="{!! (!isset($merge['category']) || $merge['category']==$pid)?'bg-blue':'' !!}" href="{!! URL('bre/service').'?'.http_build_query(array_merge(array_except($merge,'keywords'),['category'=>0])) !!}">全部</a>--}}
                            ...
                            <a class="{!! (isset($merge['type']) && $merge['type'] == '2')?'bg-blue':'' !!}" href="{!! URL('/bre/shop').'?type=2' !!}">服务</a><a class="{!! (isset($merge['type']) && $merge['type'] == '1')?'bg-blue':'' !!}" href="{!! URL('/bre/shop').'?type=1' !!}">作品</a>
            ...
            <div class="g-taskmain">
                <div class="clearfix g-taskmainhd">
                    <div class="pull-left">
                        <a href="{!! URL('bre/shop') !!}" class="{!! !isset($merge['desc'])?'g-taskmact':'' !!}">综合</a>
                        <span>|</span>
                        <a class="{!! (isset($merge['desc']) && $merge['desc'] == 'cash')?'g-taskmaintime':'' !!}" href="{!! URL('bre/shop').'?desc=cash' !!}">
                            金额 <i class="glyphicon glyphicon-arrow-down"></i>
                        </a>
                        <span>|</span>
                        <a class="{!! (isset($merge['desc']) && $merge['desc'] == 'sales_num')?'g-taskmaintime':'' !!}" href="{!! URL('bre/shop').'?desc=sales_num' !!}">
                            成交量 <i class="glyphicon glyphicon-arrow-down"></i>
                        </a>
                        <span>|</span>
                        <a class="{!! (isset($merge['desc']) && $merge['desc'] == 'good_comment')?'g-taskmaintime':'' !!}" href="{!! URL('bre/shop').'?desc=good_comment' !!}">
                    ...
                    <li class="col-md-3 col-sm-4 col-xs-6">
                        <div class="g-shopliwrap">
                            <div class="g-shopliimg">
                                <a class="cor-gray51" @if($gv->type == 1) href="{!! URL('/shop/buyGoods/'.$gv->id) !!}" @elseif($gv->type == 2) href="{!! URL('/shop/buyservice/'.$gv->id) !!}" @endif>
                                    <img src="{!! $domain.'/'.$gv->cover !!}" alt="" onerror="onerrorImage('{{ Theme::asset()->url('images/employ/bg2.jpg')}}',$(this))">
                                </a>
