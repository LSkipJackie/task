        ...
        <div class="needs">
            <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 col-left pull-right">
                        ...
                        <div class="wrap3 clearfix gzinfo-imgwrap">
                            ...
                            <div class="gzinfo-imginfo">
                                ...
                                <p class="gzinfo-infoicon">
                                    ...
                                    @endif
                                    @if(in_array('email_status',$user_data['auth']))
                                ...
                                <p class="cor-gray51">好评数<span class="cor-blue">{{ $user_data['employee_praise_rate'] }}</span> | 好评率<span class="cor-blue">{{ $user_data['good_rate'] }}%</span></p>
                            </div>
                        </div>
                        <div class="wrap4 employworkico">
                            <a href="" class="icogz taskconico" data-toggle="modal" data-target="#myModalwk">联系雇主</a>
                            @if(Auth::check())
                                @if($isFocus)
                ...
                <div class="needs-sidebar needs-sidebar-right">
                    ...
                    <div class="needs-sidebar-wrap">
                        ...
                        <div class="wrap4 employworkico">
                            @if(Auth::check())
                            <a href="javascript:;" title="联系TA" class="ico1 taskconico icogz" data-toggle="modal" data-target="#myModalgz" data-values="{{ $employ_data['uid'] }}" data-id="{{$contact}}" id="contactHe"><i></i>联系TA</a>
                            @endif
                            @if(!$user_shop)
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 col-left">
                ...
                <div class="gzinfo-mainup gzinfo-mainpay gzinfo-mainshow">
                    ...
                    <div class="clearfix">
                        <textarea datatype="*" errormsg="请输入" id="liMit" class="textarea inputxt" name="desc"></textarea>
