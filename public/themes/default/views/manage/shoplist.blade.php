                ...
                <form class="form-inline search-group" role="form" action="/manage/shopList" method="get">
                    ...
                    <div class="form-group search-list width285">
                        ...
                        <select class="sort-list" name="by">
                            <option value="shop.id" @if(isset($merge['by']) && $merge['by'] == 'shop.id')selected="selected"@endif>默认排序</option>
                            <option value="enterprise_auth.created_at" @if(isset($merge['by']) && $merge['by'] == 'shop.created_at')selected="selected"@endif>开店时间</option>
                        </select>
                        <select name="order">
