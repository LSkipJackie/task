        ...
        <form  role="form" class="form-inline search-group">
            <div class="">
                <div class="form-group search-list width285">
                    ...
                    <input type="text" name="uid" @if(isset($uid))value="{!! $uid !!}"@endif/></div>
                <div class="form-group search-list width285">
                    <label for="">用户名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    <input type="text" name="username" @if(isset($username))value="{!! $username !!}"@endif/></div>
                <div class="form-group search-list">
                    <label for="">QQ　　　　</label><input type="text" name="QQ" @if(isset($QQ))value="{!! $QQ !!}"@endif/></div>
            ...
            <div class="">
                <div class="form-group search-list width285">
                    ...
                    <input type="text" name="email" @if(isset($email))value="{!! $email !!}"@endif/></div>
                <div class="form-group search-list width285">
                    <label>联系电话　</label><input type="text" name="telephone" @if(isset($telephone))value="{!! $telephone !!}"@endif/></div>
            </div>
            <div class="space"></div>
            <div class="">
                <div class="form-group search-list width285">
                ...
                <div class="form-group search-list">
                    ...
                    <select class="sort-list" name="order">
                        <option @if(isset($order) && $order == 'desc')selected="selected"@endif value="desc">编号降序</option>
                        <option @if(isset($order) && $order == 'asc')selected="selected"@endif value="asc">编号升序</option>
                    </select>
                </div>
            </div>
        </form>
