...
<div class="g-backrealdetails clearfix bor-border interface">
    <form class="form-horizontal" action="/manage/postGoodsConfig" method="post">
        ...
        <div class="form-group interface-bottom col-xs-12">
            ...
            <div class="col-sm-9 "><input type="text" name="divade_rate" @if(isset($goods_config['divade_rate']))value="{!! $goods_config['divade_rate'] !!}" @endif  class="change_ids"> %(交易成功后，站长提取佣金的百分比，设为0即无抽佣)</div>
        </div>
        <div class="form-group interface-bottom col-xs-12">
