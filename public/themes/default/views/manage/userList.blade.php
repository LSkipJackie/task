        ...
        <form  role="form" class="form-inline search-group" action="{!! url('manage/userList') !!}" method="get">
            <div class="">
                <div class="form-group search-list width285">
                    ...
                    <input type="text" name="uid" @if(isset($uid))value="{!! $uid !!}"@endif />
                </div>
                <div class="form-group search-list width285">
                    <label for="">用户名　　</label>
            ...
            <div class="">
                ...
                <div class="form-group search-list width285">
                    ...
                    <select class="" name="by">
                        ...
                        <option @if(isset($by) && $by == 'created_at')selected="selected"@endif value="created_at">注册时间</option>
                    </select>
