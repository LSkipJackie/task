    ...
    <form role="form" class="form-inline search-group" action="/manage/ShopRightsList" method="get">
        ...
        <div class="form-group search-list width285">
            ...
            <select name="paginate">
                <option {!!(!isset($merge['paginate']) || $merge['paginate']==10)?'selected':'' !!} value="10">10条</option>
                <option {!! (isset($merge['paginate']) && $merge['paginate']==20)?'selected':'' !!} value="20">20条</option>
                <option {!! (isset($merge['paginate']) && $merge['paginate']==30)?'selected':'' !!} value="30">30条</option>
            </select>
        </div>
