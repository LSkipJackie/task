                                    ...
                                    <form class="form-inline" role="form" action="/manage/link" method="get">
                                        <div class="well">
                                            <div class="form-group search-list width285">
                                                　<label for="">链接ID　</label>
                                                <input type="text" id="id" name="id" value="@if(isset($id)){!! $id !!}@endif">
                                            </div>
                                            <div class="form-group search-list width285">
                                            ...
                                            <div class="form-group search-list width285">
                                                ...
                                                <select name="by">
                                                    ...
                                                    <option value="addtime" @if(isset($by) && $by == 'addtime')selected="selected"@endif>发布时间</option>
                                                </select>
                                                <select name="order">
                                                    ...
                                                    <tr>
                                                        <td class="center">
                                                            <label>
                                                                ...
                                                                <input type="checkbox" name="chk  allcheck" class="ace " value="{!! $v->id !!}"/>
                                                                <span class="lbl"></span>
                                                                {{ $v['id'] }}
                                                            </label>
                                                        </td>
