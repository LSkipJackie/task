                ...
                <div class="table-responsive ">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th class="s-amount">作品数量（@if($goods_info->unit == 0)个@elseif($goods_info->unit == 1)时
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="cor-orange31 text-size12">￥{!! $goods_info->cash !!}/@if($goods_info->unit == 0)件@else时@endif</span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
