        ...
        <div class="shop-main buygoods-header">
            <div class="personal-info buygoods-info clearfix">
                <div class="personal-info-words clearfix buygoods-info-words">
                    ...
                    <img src="{{ $domain.'/'.$service['cover'] }}" alt="" class="img-circle personal-info-pic buygoods-img" onerror="onerrorImage('{{ Theme::asset()->url('images/employ/bg2.jpg')}}',$(this))" >
                    @else
                    ...
                    <div class="personal-info-block-name">
                        ...
                        <div class="alert alert-warning mg-bottom10">
                            ...
                            <p class="text-size12 cor-orange31"><span class="cor-gray89">服务价格：</span><span class="text-size16">￥</span><span class="text-size28">{{ $service['cash'] }}</span>
                                @if($is_owner!=0)
