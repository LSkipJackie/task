                    ...
                    @if($balance_pay)
                        <form class="form-horizontal" role="form" action="/shop/postPayOrder" method="post"  name="goods_form">
                            ...
                            <div class="text-center clearfix">
                                ...
                                <a href="/shop/buyGoods/{{ $id }}" class="cor-gray93 btn-big">返回</a>
                            </div>
                        </form>
                    @else
                        <!--余额不足状态-->
                        <div class="text-size14 cor-gray51">
                            ...
                            <a href="/shop/buyGoods/{{ $id }}" class="btn btn-white bor-radius2">返回</a>
                            <br>
                        </div>
                    @endif
                </div>
                     ...
                     <div class="modal-body text-center clearfix">
                         ...
                         <div class="col-sm-8 hidden-xs">
                             <div class="cor-gray51 text-left">
                                 ...
                                 <div class="space"></div>
                                 <p>
                                     <a href="/shop/buyGoods/{{ $id }}" type="button" class="btn btn-primary btn-sm btn-blue btn-big1 bor-radius2" >已完成付款</a>&nbsp;
