            ...
            <div class="needs-sidebar-wrap">
                ...
                <div class="wrap4" >
					@if(Auth::check())
						...
						<a href="javascript:;" class="ico1 shop-im"><i></i>联系我</a>
						@endif
					@else
			            ...
			            <div class="clearfix">
			            	<div class="clearfix pull-left hidden-xs hidden-sm">
				            	<div class="clearfix pull-left chart-mg">
					            	<span class="chart1" data-percent="{!! $speedScore !!} ">
										<span class="percent"></span>
									</span>
									<p class="text-center text-size14 cor-gray51">工作速度</p>
					            </div>
					            <div class="clearfix pull-left chart-mg">
					            	<span class="chart2" data-percent="{!! $qualityScore !!}">
										<span class="percent"></span>
									</span>
									<p class="text-center text-size14 cor-gray51">工作质量</p>
					            </div>
					            <div class="clearfix pull-left chart-mg">
					            	<span class="chart3" data-percent="{!! $attitudeScore !!}">
										<span class="percent"></span>
									</span>
