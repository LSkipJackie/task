                    ...
                    <div class="personal-info-block shop-width772">
                        ...
                        <div class="alert alert-warning mg-bottom10">
                            ...
                            <p class="text-size12 cor-orange31"><span class="cor-gray89">作品价格：</span>
                                ...
                                <span class="text-size16">/@if($goods_info->unit == 0)个@elseif($goods_info->unit == 1)时
                        ...
                        <div class="clearfix buygoods-btn-wrap">
                            @if($owner == false)
                                ...
                                @elseif($collect_shop == 0)
                                    @if(Auth::check())
                                        <a class="buygoods-collect" id="shop_id" href="javascript:;" shop_id="{!! $goods_info->shop_id !!}">收藏店铺</a>
                                    @else
                                        <a class="buygoods-collect" href="{!! URL('/login') !!}">收藏店铺</a>
                                    @endif
                                @endif
                            @endif
                                {{--分享--}}
