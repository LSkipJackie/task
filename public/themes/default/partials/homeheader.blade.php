                        ...
                        <ul class="nav navbar-nav overhide">
                            ...
                            @if(!empty(Theme::get('nav_list')))
                                ...
                                @foreach(Theme::get('nav_list') as $m => $n)
                                    @if($n['is_show'] == 1 && $m!=0)
                                        {{--<li><a class="topborbtm" href="{!! $n['link_url'] !!}" @if($n['is_new_window'] == 1)target="_blank"@endif >{!! $n['title'] !!}</a></li>--}}

                                        <li @if($n['link_url'] == $_SERVER['REQUEST_URI']) class="hActive" @endif><a class="text-center" href="{!! $n['link_url'] !!}" @if($n['is_new_window'] == 1)target="_blank" @endif >{!! $n['title'] !!}</a></li>
                                    @endif
                                @endforeach
                                </ul></li>
                            @else
                            ...
                            <li class="s-sign clearfix hidden-md hidden-xs hidden-sm navactiveImg">
                                @if(Auth::check())
                                    {{--<div class="z-navactive topheadposi1">--}}
                                        <a href="javascript:;" class="u-img topheadimg" data-toggle="dropdown" class="dropdown-toggle"><img src="@if(!empty(Theme::get('avatar'))) {!!  url(Theme::get('avatar')) !!} @else {!! Theme::asset()->url('images/default_avatar.png') !!} @endif" alt="..." class="img-circle" width="31" height="34"></a>
                                    ...
                                    {{--</div>--}}
                                @else
                                {{--<a href="#" class="text-size14 pull-left">登录</a><a class="pull-left hidden-xs">|</a><a href="#" class="text-size14 pull-right">注册</a>--}}
                        ...
                        <div class="collapse navbar-collapse bs-js-navbar-scrollspy">
                            <ul class="nav navbar-nav">
                                @if(!empty(Theme::get('nav_list')))
                                    @foreach(Theme::get('nav_list') as $m => $n)
                                        @if($n['is_show'] == 1)
                                            {{--<li><a href="{!! $n['link_url'] !!}" @if($n['is_new_window'] == 1)target="_blank" @endif>{!! $n['title'] !!}</a></li>--}}
