...
<div class="bg-white s-slidecenter">
    <div class="accordion-style1 panel-group accordion-style2 g-side1" id="accordion1">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title clearfix">
                    <a href="#collapseThree1" data-parent="#accordion" data-toggle="collapse" class="accordion-toggle g-wrap1 g-active">
            ...
            <div id="collapseThree1" class="panel-collapse {{ (preg_match('/^\/user\/(myTask|acceptTasksList|workComment)/',$_SERVER['REQUEST_URI']))?'in':'' }}">
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseThree3" class="panel-collapse collapse {{ (preg_match('/^\/user\/(switchUrl|shop|goodsShop|waitGoodsHandle|pubGoods|editGoods|serviceList|myShopSuccessCase|shopcommentowner|addShopSuccess|editShopSuccess)/',$_SERVER['REQUEST_URI']))?'in':'' }}">
